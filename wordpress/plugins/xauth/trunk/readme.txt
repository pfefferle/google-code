...
Tags: XAuth, OExchange, Share, OAuth, XRD
Requires at least: 2.7
Tested up to: 2.9.9
Stable tag: 0.1

This plugin enables "XAuth" support for WordPress (http://xauth.org).
...
1. Upload the `xauth`-folder to the `/wp-content/plugins/` directory
